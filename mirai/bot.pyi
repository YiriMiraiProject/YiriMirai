...
class Mirai(AdapterInterface):
    ...
    class __FileInfoProxy():
        async def get(self, id: str, target: int, with_download_info: Optional[bool] = None, path: Optional[str] = None) -> FileProperties:
            """查看文件信息。
        ...
        async def __call__(self, id: str, target: int, with_download_info: Optional[bool] = None, path: Optional[str] = None) -> FileProperties:
            """查看文件信息。
    ...
    class __FileListProxy():
        async def get(self, id: str, target: int, with_download_info: Optional[bool] = None, path: Optional[str] = None, offset: Optional[int] = None, size: Optional[int] = None) -> FileProperties:
            """查看文件列表。
        ...
        async def __call__(self, id: str, target: int, with_download_info: Optional[bool] = None, path: Optional[str] = None, offset: Optional[int] = None, size: Optional[int] = None) -> FileProperties:
            """查看文件列表。
    ...
    class __FileMkdirProxy():
        async def set(self, id: str, target: int, directory_name: str, path: Optional[str] = None) -> FileProperties:
            """创建文件夹。
        ...
        async def __call__(self, id: str, target: int, directory_name: str, path: Optional[str] = None) -> FileProperties:
            """创建文件夹。
    ...
    class __FileUploadProxy():
        async def set(self, type: Literal['group'], target: int, file: Union[str,Path], path: str = '') -> FileProperties:
            """文件上传。
        ...
        async def __call__(self, type: Literal['group'], target: int, file: Union[str,Path], path: str = '') -> FileProperties:
            """文件上传。
    ...
    class __SendFriendMessageProxy():
        async def set(self, target: int, message_chain: Union[MessageChain,Iterable[Union[MessageComponent,str]],MessageComponent,str], quote: Optional[int] = None) -> int:
            """发送好友消息。
        ...
        async def __call__(self, target: int, message_chain: Union[MessageChain,Iterable[Union[MessageComponent,str]],MessageComponent,str], quote: Optional[int] = None) -> int:
            """发送好友消息。
    ...
    class __SendTempMessageProxy():
        async def set(self, qq: int, group: int, message_chain: Union[MessageChain,Iterable[Union[MessageComponent,str]],MessageComponent,str], quote: Optional[int] = None) -> int:
            """发送临时消息。
        ...
        async def __call__(self, qq: int, group: int, message_chain: Union[MessageChain,Iterable[Union[MessageComponent,str]],MessageComponent,str], quote: Optional[int] = None) -> int:
            """发送临时消息。
