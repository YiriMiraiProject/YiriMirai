...
按照 mirai-api-http 的[配置文档](https://project-mirai.github.io/mirai-api-http/)配置 mirai-api-http，启用 websocket adapter，配置完成后记录你设置的 `verifyKey` ，以及 websocket adapter 的 `host` 和 `port` 。
...
2021-02-15 00:00:00 - INFO     成功登录到账号12345678。
2021-02-15 00:00:00 - INFO     机器人开始运行。按 Ctrl + C 停止。
```
